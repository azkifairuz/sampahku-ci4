      ...
      if ($showHistoriAntar == null) {
        ...
        foreach ($showHistoriAntar as $historiAntar) {
          ...
          <div class="rounded-lg border-gray-200 w-full h-fit shadow-text-field bg-blueMain-surface p-5 text-white">
            <table>
              ...
              <tr>
                ...
                <td class="px-4">:</td>
                <td class="text-lg capitalize">
                  <?php echo $nilaiCoin * $historiAntar->berat ?>
                </td>
              </tr>
              <tr>
          ...
          <a class="bg-red-500 w-1/2 text-white text-center uppercase rounded-xl py-2  px-5"
            href="<?php echo base_url('orderSampahMitra/tolakTerima/' . $historiAntar->id) ?>">

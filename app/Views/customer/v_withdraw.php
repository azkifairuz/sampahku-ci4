...
<form class=" w-[700px] mx-auto rounded-2xl  bg-surface">
 ...
 <h1 class=" text-white">Cairkan Koin
    ...
    <div class="relative  z-0 w-full mb-6 group">
      <input type="withdraw" name="withdraw" id="withdraw" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 b appearance-none  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder=" " required />

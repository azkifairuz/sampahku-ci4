<?php echo view('layout/v_sidebar_admin') ?>
<!DOCTYPE html>
<html>
...
<head>
  ...
  <title>Daftarkan Mitra | Admin</title>
</head>
...
<body class="font-poppins  md:mx-10 my-5  bg-[#F1FAEE]">
  ...
  <section class="flex flex-col mt-10">
    <div
      class="md:w-[633px] w-full mx-auto flex flex-col py-[52px] items-center text-white bg-blueMain-surface md:rounded-md px-5 h-screen md:h-fit  md:px-[72px]">
